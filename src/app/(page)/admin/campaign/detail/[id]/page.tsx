...
export async function generateMetadata({params}: { params: Params }) {
    ...
    return {
        title: `${campaign?.name} - Admin Local Hunt`,
        ...
        <div className='space-y-6'>
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                    <Badge
                        variant={getBadgeStatusVariant(campaign?.status.toLowerCase())}>{campaign?.status.toLowerCase()}</Badge>
                    <Dialog>
                        ...
                        <DialogContent>
                            ...
                            <div className='size-[300px] mx-auto'>
                                <Image src={qrUrl} alt='QR Code Local Hunt' width={300} height={300}
