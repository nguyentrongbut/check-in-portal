...
const WalletPage = async ({searchParams}: SearchParamsProps) => {
                ...
                <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-3">
                            <div
                                className="flex justify-between items-center p-3 0 bg-blue-50 rounded-lg text-blue-600">
                                <span className="font-medium">Current Rate</span>
                                <span className="font-bold">1 USD = 100 points</span>
                            </div>
                            <div
                                className="flex justify-between items-center p-3 bg-yellow-50 rounded-lg text-yellow-600">
                        ...
                        <div className="space-y-3">
                            <div
                                className="flex justify-between items-center p-3 bg-primary/10 rounded-lg text-primary">
